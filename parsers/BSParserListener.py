# Generated from /BioScriptGrammar/grammar\BSParser.g4 by ANTLR 4.7.2
from antlr4 import *
...
class BSParserListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by BSParser#useby.
    def enterUseby(self, ctx:BSParser.UsebyContext):
        pass

    # Exit a parse tree produced by BSParser#useby.
    def exitUseby(self, ctx:BSParser.UsebyContext):
        pass
