...
expression
 ...
 annotations
     ...
     | AT_SYMBOL RELATIVE_DENSITY FLOAT_LITERAL
     | AT_SYMBOL WEIGHT_DENSITY FLOAT_LITERAL
     | AT_SYMBOL SPECIFIC_GRAVITY FLOAT_LITERAL
     | AT_SYMBOL CONCENTRATION FLOAT_LITERAL
     | AT_SYMBOL SPECIFIC_VOLUME FLOAT_LITERAL
