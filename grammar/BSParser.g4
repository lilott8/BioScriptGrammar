...
expression
 ...
 physic_annotation
 : MASS_NUMBER (INTEGER_LITERAL | FLOAT_LITERAL)
 | EFFICIENCY_NUMBER (INTEGER_LITERAL | FLOAT_LITERAL)
 | PRESSURE_NUMBER (INTEGER_LITERAL | FLOAT_LITERAL)
 | FORCE_NUMBER (INTEGER_LITERAL | FLOAT_LITERAL)
 | SPEED_NUMBER (INTEGER_LITERAL | FLOAT_LITERAL)
 | FRICTION_NUMBER (INTEGER_LITERAL | FLOAT_LITERAL)
 | USEBY (INTEGER_LITERAL | FLOAT_LITERAL);
